...
import com.example.stores.MainApp; // Để chuyển màn hình
...
public class LoginController {
    ...
    public void initialize() {
        // LanguageManager sẽ tự load ngôn ngữ mặc định
    ...
    private void updateTexts() {
        ...
        // Cập nhật text cho nút ngôn ngữ dựa trên locale hiện tại của LanguageManager
